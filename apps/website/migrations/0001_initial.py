# Generated by Django 5.2.10 on 2026-01-07 23:54
...
class Migration(migrations.Migration):
    ...
    operations = [
                    ...
                    wagtail.fields.StreamField(
                        ...
                        block_lookup={
                            ...
                            1: (
                                ...
                                (),
                                {"label": "Custom CSS Class", "max_length": 255, "required": False},
                            ),
                            2: (
                                "wagtail.blocks.CharBlock",
                                (),
                            ...
                            25: ("wagtail.images.blocks.ImageChooserBlock", (), {"label": "Image"}),
                            26: (
                                "wagtail.blocks.StructBlock",
                                [[("settings", 3), ("image", 25)]],
                                {},
                            ...
                            64: (
                                "wagtail.blocks.CharBlock",
                                (),
                                {"label": "Modal heading", "max_length": 255, "required": False},
                            ),
                            65: (
                                "wagtail.blocks.StreamBlock",
                                [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Indirizzo della località per la visualizzazione sulla mappa.",
                        max_length=500,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Coordinate nel formato 'latitudine,longitudine'. Clicca sulla mappa.",
                        max_length=250,
                ...
                (
                    ...
                    models.SmallIntegerField(
                        blank=True,
                        default=14,
                        help_text="Livello di zoom della mappa (1-18).",
                        null=True,
                        verbose_name="Livello zoom",
                    ),
                ),
                (
                    "author_display",
                    models.CharField(
                        blank=True,
                        help_text="Nome autore da visualizzare sull'evento.",
                        max_length=255,
                        verbose_name="Autore visualizzato",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                "verbose_name": "Pagina indice località",
            },
            bases=("coderedcms.coderedpage",),
        ),
        migrations.CreateModel(
                ...
                (
                    ...
                    wagtail.fields.StreamField(
                        ...
                        block_lookup={
                            ...
                            15: ("wagtail.images.blocks.ImageChooserBlock", (), {"label": "Image"}),
                            16: (
                                "wagtail.blocks.StructBlock",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "verbose_name_plural": "Pagine web",
            },
            bases=("coderedcms.coderedpage",),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_display",
                    models.DateField(blank=True, null=True, verbose_name="Display publish date"),
                ),
                (
                    "author",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "end",
                    models.DateTimeField(blank=True, db_index=True, null=True, verbose_name="end"),
                ),
                (
                    "repeat",
                ...
                (
                    "repeat_until",
                    models.DateField(blank=True, null=True, verbose_name="repeat_until"),
                ),
                (
                    "event",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "button_text",
                    models.CharField(default="Submit", max_length=255, verbose_name="Button text"),
                ),
                (
                    "button_style",
                    models.CharField(
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("btn-sm", "Small"), ("", "Default"), ("btn-lg", "Large")],
                        default="",
                        max_length=255,
            ...
            options={
                "verbose_name": "Pagina form",
                "verbose_name_plural": "Pagine form",
            },
            bases=("coderedcms.coderedpage", models.Model),
        ),
        migrations.CreateModel(
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "File Upload",
                                [("file", "Secure File - login required to access uploaded files")],
                            ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Nome identificativo del footer.",
                        max_length=255,
                        verbose_name="Nome",
                    ),
                ),
                    ...
                    wagtail.fields.StreamField(
                        ...
                        block_lookup={
                            ...
                            11: (
                                "wagtail.blocks.RichTextBlock",
                                (),
                                {"features": ["bold", "italic", "link"], "label": "Testo"},
                            ),
                        },
                        verbose_name="Contenuto footer",
                    ),
                ),
                (
                    "locale",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Nome identificativo della navbar.",
                        max_length=255,
                        verbose_name="Nome",
                    ),
                ),
                    ...
                    wagtail.fields.StreamField(
                        ...
                        block_lookup={
                            ...
                            12: (
                                "wagtail.blocks.CharBlock",
                                (),
                                {"label": "Titolo dropdown", "max_length": 255, "required": True},
                            ),
                            13: ("wagtail.blocks.ListBlock", (10,), {"label": "Link nel dropdown"}),
                            14: (
                                "wagtail.blocks.StructBlock",
                                [[("settings", 11), ("title", 12), ("links", 13)]],
                                {},
                            ),
                        },
                        verbose_name="Voci menu",
                    ),
                ),
                (
                    "locale",
